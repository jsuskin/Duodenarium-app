    ...
    return (
      <div className="external-links">
        <a href={this.props.discogs} target="_blank" rel="noopener noreferrer">
          <img src={discogsLogo} alt="discogs logo" className={`link-logo discogs-logo${this.props.discogs.length ? '' : ' disabled-link'}`} name="discogs-logo" />
        </a>
        <a href={this.props.bandcamp} target="_blank" rel="noopener noreferrer">
          <img src={bandcampLogo} alt="bandcamp logo" className={`link-logo bandcamp-logo${this.props.bandcamp.length ? '' : ' disabled-link'}`} name="bandcamp-logo" />
        </a>
        <a href={this.props.soundcloud} target="_blank" rel="noopener noreferrer">
          <iframe
            title="Soundcloud"
            className={`link-logo soundcloud-logo${this.props.soundcloud.length ? '' : ' disabled-link'}`}
